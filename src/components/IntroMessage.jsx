...
const IntroMessage = (props) => {
    ...
    return (
        <div>
            ...
            <div id="first-header"> 
                <div> <span className="color-blue"> [*] </span> <span> Started reverse TCP handler </span> <span> on 192.168.1.101:2345 </span> </div>
                <div> <span className="color-blue"> [*] </span> Sending stage (36 bytes) </div>
