...
function function02M(){
  $("#mform2").submit(function(e) {
   ...
   if(input2 == 'whoami'){
    ...
    document.getElementById("msection").insertAdjacentHTML("afterend","<table id=\"table1\"><tr id=\"catcon\"><td><span><span id=\"mtimestamp9\"></span> &lt;sync_pundit&gt;</span></td></tr><tr><td><p class=\"m-catcon-p1\"><a href=\"mailto:Sync_Pundit@syncpundit.ml\">Google</a></p><p class=\"m-catcon-p2\"><a href=\"https://twitter.com/Sync_Pundit\">Twitter</a></p><p class=\"m-catcon-p3\"><a href=\"https://www.linkedin.com/in/deon-trevor-mpofu\">Linkedin</a></p></td></tr><tr><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td><span class=\"m-cont-s\">root@syncpundit:~#</span></td></tr><tr><td><form action=\"\" id=\"mform3\"><input class=\"m-cont-s-form\" type=\"text\" id=\"mcode3\" autocomplete=\"off\" autofocus spellcheck=\"false\"><input type=\"submit\" onclick=\"function03M();\"></form></td></tr></table>");
...
function function05M(){
  $("#mform6").submit(function(e) {
    ...
    document.getElementById("msection").insertAdjacentHTML("afterend","<table id=\"table1\"><tr id=\"catcon\"><td><span><span id=\"mtimestamp9\"></span> &lt;sync_pundit&gt;</span></td></tr><tr><td><p class=\"catcon-p1\"><a href=\"mailto:Sync_Pundit@syncpundit.ml\">Google</a></p><p class=\"catcon-p2\"><a href=\"https://twitter.com/Sync_Pundit\">Twitter</a></p><p class=\"catcon-p3\"><a href=\"https://www.linkedin.com/in/deon-trevor-mpofu\">Linkedin</a></p></td></tr><tr><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td><span class=\"m-cont-s\">root@syncpundit:~#</span></td></tr><tr><td><form action=\"\" id=\"mform6\"><input class=\"m-cont-s-form\" type=\"text\" id=\"mcode6\" autocomplete=\"off\" autofocus spellcheck=\"false\"><input type=\"submit\" onclick=\"function06M();\"></form></td></tr></table>");
